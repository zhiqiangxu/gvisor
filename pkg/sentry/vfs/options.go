...
// OpenExtraFlags provides internal only flags for OpenAt().
type OpenExtraFlags struct {
...
type OpenOptions struct {
	...
	// ExtraFlags contains flags not visible/settable from user mode.
	ExtraFlags OpenExtraFlags
}
